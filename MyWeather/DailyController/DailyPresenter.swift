...
extension DailyPresenter: DailyForecastPresenterOutput {
    ...
    func setDataForViews(dayView: DayView, nightView: NightView, sunMoonView: SunMoonView, completion: () -> IndexPath) {
        ...
        dayView.windStack.valueLabel.text = "\(Int(model.forecasts[completion().item].windSpeed))m/s"
        ...
        sunMoonView.moonStack.timeLabel.text = ((24 * 3600) - (moonsetTime - moonriseTime)).toTimeInterval()
